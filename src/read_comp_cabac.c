 ...
 *      residual( 0, 15 )
 *      7.3.5.3 Residual data syntax: residual( startIdx, endIdx )
 *        residual_luma
 *        7.3.5.3.1 Residual luma syntax: residual_block
 *          7.3.5.3.3 Residual block CABAC syntax: residual_block_cabac
 ************************************************************************
 */
static void read_CBP_and_coeffs_from_NAL_CABAC_420(Macroblock *currMB)
{
  ...
  // DOC: if( MbPartPredMode( mb_type, 0 ) != Intra_16x16 )
  if (!IS_I16MB (currMB))
  {
